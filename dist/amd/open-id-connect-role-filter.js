...
define(["require", "exports", "aurelia-framework", "./open-id-connect-roles"], function (require, exports, aurelia_framework_1, open_id_connect_roles_1) {
    ...
    OpenIdConnectRoleFilterValueConverter = __decorate([aurelia_framework_1.autoinject, aurelia_framework_1.noView, aurelia_framework_1.valueConverter("open-id-connect-role-filter"), __metadata('design:paramtypes', [])], OpenIdConnectRoleFilterValueConverter);
