System.register(["aurelia-framework", "aurelia-router", "./open-id-connect-roles"], function (exports_1, context_1) {
    "use strict";
    ...
    var aurelia_framework_1, aurelia_router_1, open_id_connect_roles_1, OpenIdConnectAuthorizeStep;
    return {
        setters: [
        ...
        execute: function () {
            OpenIdConnectAuthorizeStep = /** @class */ (function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    if (this.requiresRole(navigationInstruction, open_id_connect_roles_1.OpenIdConnectRoles.Authenticated)) {
                                        if (user === null) {
                                            ...
                                            return [2 /*return*/, next.cancel(redirect)];
                                        }
                                    }
            ...
            exports_1("OpenIdConnectAuthorizeStep", OpenIdConnectAuthorizeStep);
        }
    };
});
